...
O bot utiliza uma variável de ambiente chamada `TOKEN` para se conectar ao Discord.

1.  Crie um arquivo chamado `.env` na mesma pasta do bot.
2.  Copie o conteúdo do arquivo `.env.example` para o `.env`.
3.  Substitua `SEU_TOKEN_AQUI` pelo token do seu bot.
